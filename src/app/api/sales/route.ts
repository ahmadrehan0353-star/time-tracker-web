...
export async function POST(request: Request) {
  ...
  // Save the lead to Firestore as a durable record, independent of whether
  // the email below succeeds. This is best-effort and never blocks or
  // changes the response the user sees - existing email behavior below is
  // untouched.
  try {
